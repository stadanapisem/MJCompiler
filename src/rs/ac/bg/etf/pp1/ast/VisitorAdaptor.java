...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(OperatorGrt OperatorGrt) { visit(); }
    public void visit(OperatorNeq OperatorNeq) { visit(); }
    public void visit(OperatorEq OperatorEq) { visit(); }
    public void visit(CondOpFactor CondOpFactor) { visit(); }
    public void visit(TermCondFactor TermCondFactor) { visit(); }
    public void visit(OperatorAnd OperatorAnd) { visit(); }
    public void visit(TerminalCondFactor TerminalCondFactor) { visit(); }
    public void visit(CondFactorList CondFactorList) { visit(); }
    ...
    public void visit(Actual_parameter_listDerived2 Actual_parameter_listDerived2) { visit(); }
    ...
    public void visit(Optional_elseDerived1 Optional_elseDerived1) { visit(); }
    public void visit(If_statement_headerDerived1 If_statement_headerDerived1) { visit(); }
    ...
    public void visit(ConstIdentifier ConstIdentifier) { visit(); }
    public void visit(ConstId ConstId) { visit(); }
    public void visit(ConstIdTerm ConstIdTerm) { visit(); }
    public void visit(ConstIdList ConstIdList) { visit(); }
    public void visit(ConstDeclarationLine ConstDeclarationLine) { visit(); }
