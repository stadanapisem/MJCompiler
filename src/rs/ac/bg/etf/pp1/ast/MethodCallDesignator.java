...
public class MethodCallDesignator extends Designator_statement {

    private Method_call_ident method_call_ident;
    private Actual_parameter_section actual_parameter_section;

    public MethodCallDesignator (Method_call_ident method_call_ident, Actual_parameter_section actual_parameter_section) {
